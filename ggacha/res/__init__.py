ITEMS = {
    ...
    "3618": {"zh-cn": "枫原万叶", "zh-tw": "楓原萬葉", "en-us": "Kaedehara Kazuha", "ja-jp": "", "ko-kr": ""},
    ...
    "1A50": {"zh-cn": "苍古自由之誓", "zh-tw": "蒼古自由之誓", "ja-jp": "北風のプレシャス", "ko-kr": "보레아스의 조숙", "en-us": "Freedom-Sworn"},
    ...
    "5B40": {"zh-cn": "西风猎弓", "zh-tw": "西風獵弓", "ja-jp": "西風猟弓", "ko-kr": "Favonius Warbow", "en-us": "Favonius Warbow"},
    ...
    "302": [
        {
            ...
            "plan": ["2020-09-28 11:00:00", "2020-10-18 17:59:59"],
            "items": {"up": [
                "风鹰剑", "阿莫斯之弓", "笛剑", "钟剑", "流浪乐章", "绝弦", "西风长枪",
                "A160", "A510", "B110", "B230", "B480", "B550", "B340"
            ]}
        },
        {
            "ver": "1.0",
            ...
            "items": {"up": [
                ...
                "A470", "A210", "B141", "B241", "B450", "B541", "B350"
            ]}
        },
        {
            "ver": "1.1",
            ...
            "plan": ["2020-11-11 11:00:00", "2020-12-01 15:59:59"],
            "items": {"up": [
                "尘世之锁", "天空之翼", "笛剑", "雨裁", "昭心", "弓藏", "西风长枪",
                "A411", "A570", "B110", "B250", "B410", "B510", "B340"
            ]}
        },
        {
            "ver": "1.1",
            ...
            "items": {"up": [
                ...
                "A310", "A211", "B111", "B230", "B440", "B540", "B350"
            ]}
        },
        {
            "ver": "1.2",
            ...
            "items": {"up": [
                ...
                "A110", "A410", "B140", "B240", "B340", "B450", "B550"
            ]}
        },
        {
            "ver": "1.2",
            ...
            "items": {"up": [
                ...
                "A510", "A240", "B141", "B230", "B350", "B410", "B540"
            ]}
        },
        {
            "ver": "1.3",
            ...
            "items": {"up": [
                ...
                "A170", "A370", "B110", "B241", "B510", "B410", "B340"
            ]}
        },
        {
            "ver": "1.3",
            ...
            "items": {"up": [
                ...
                "A380", "A210", "B210", "B310", "B111", "B541", "B480"
            ]}
        },
        {
            "ver": "1.4",
            ...
            "items": {"up": [
                ...
                "A540", "A140", "B150", "B441", "B240", "B540", "B350"
            ]}
        },
        {
            "ver": "1.4",
            ...
            "time": ["2021-04-06 18:00:00", "2021-04-27 14:59:00"],
            "items": {"up": [
                "天空之翼", "四风原典", "暗巷猎手", "西风剑", "祭礼大剑", "西风秘典", "西风长枪",
                "A570", "A470", "B511", "B140", "B241", "B440", "B340"
            ]}
        },
        {
            "ver": "1.5",
            ...
            "time": ["2021-04-28 11:00:00", "2021-05-18 17:59:00"],
            "items": {"up": [
                "斫峰之刃", "尘世之锁", "千岩古剑", "千岩长枪", "笛剑", "昭心", "祭礼弓",
                "A110", "A411", "B210", "B310", "B110", "B410", "B541"
            ]}
        },
        {
            "ver": "1.5",
            ...
            "time": ["2021-05-18 18:00:00", "2021-06-08 14:59:00"],
            "items": {"up": [
                "松籁响起之时", "风鹰剑", "祭礼剑", "雨裁", "匣里灭辰", "祭礼残章", "弓藏",
                "A260", "A160", "B141", "B250", "B350", "B450", "B510"
            ]}
        },
        {
            "ver": "1.6",
            ...
            "time": ["2021-06-09 11:00:00", "2021-06-29 17:59:00"],
            "items": {"up": [
                "四风原典", "天空之傲", "幽夜华尔兹", "匣里龙吟", "钟剑", "西风长枪", "流浪乐章",
                "A470", "A240", "B560", "B111", "B230", "B340", "B480"
            ]}
        },
        {
            "ver": "1.6",
            ...
            "time": ["2021-06-29 18:00:00", "2021-07-20 14:59:00"],
            "items": {"up": [
                "苍古自由之誓", "天空之卷", "暗巷闪光", "暗巷的酒与诗", "暗巷猎手", "西风大剑", "匣里灭辰",
                "A150", "A410", "B150", "B441", "B511", "B240", "B350"
            ]}
        }
    ]
}
